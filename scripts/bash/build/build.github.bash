...
_PRINTJS_
JARR=($(grep -v JavaScript repos | grep -B 5 Java | grep svn_url | awk -v x=2 '{print $x}' | sed 's/\,//g' | sed 's/\"//g')) || _SIGNAL_ "100" "JARR" ; _NAMESMAINBLOCK_ CNAMES ZNAMES ; _PRINTJD_ ; exit 0 # creates array of Java language repositories
_PRINTJD_
