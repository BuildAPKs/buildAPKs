...
_GSMU_() {	
	...
	(git pull && printf "Please wait; Updating ~/buildAPKs...\\n") || (printf "Cannot update ~/buildAPKs:  Continuing...\\n")
	for LOC in "${!SBMS[@]}" 
	do
		_GSU_ $LOC
	done
